...
export default () => (
  <div className="sticky-footer-container py-8 lg:py-12 px-6 md:px-16 lg:px-24 font-sans text-black leading-tight antialiased">
    ...
    <div className="sticky-footer-grower lg:pl-32 mt-8">
      <div className="max-w-2xl">
        <div className="text-lg text-gray-darkest leading-normal spaced-y">
          ...
          <p>
            Since 2019, I've been working on a monolithic Ruby on Rails app at
          ...
          <p>
            Most of my contributions have been on the backend, with some opportunities to add
            JavaScript, jQuery, and CSS sprinkles on the frontend.
            I have also been a part of significant projects such as upgrading from Rails 5.1 to 6, adding role-based
            authorisation to our portals, migrating domains, and building and updating integrations with HubSpot
            and a Google BigQuery data warehouse.
          </p>
          <p>
            I am passionate about growing my knowledge of the web and the technologies built on top of it, and
            learning how to design software better.
    ...
    <footer className="lg:pl-32 mt-10">
